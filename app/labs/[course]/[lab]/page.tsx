...
const challenges: Record<string, { goal: string; tasks: string[]; success: string[] }> = {
  ...
  "cpp-coding-lab": { goal: "Use a vector and a loop to calculate a class average.", tasks: ["Keep the five scores in a vector.", "Calculate the total with a loop.", "Calculate the average as a decimal value.", "Change at least one score and rerun the program."], success: ["The C++ program compiles and runs.", "The displayed average changes when a score changes.", "The calculation is performed from the vector rather than hard-coded."] },
