  ...
  return (
    <div className="mt-4">
      ...
      <div className="mt-4 flex flex-wrap items-center gap-3">
        <button disabled={selected === null} onClick={() => setSubmitted(true)} className="rounded-xl bg-[#0b1f3a] px-5 py-2.5 text-sm font-bold text-white disabled:cursor-not-allowed disabled:opacity-40">Check answer</button>
